...
public class SnakesGame extends Frame {
	...
	// player two's snake
	private Snake playerTwo = new Snake(Color.RED, new Point(20, 30), LENGTH, SEGMENT_SIZE * (BOARD_WIDTH - 4));
	...
	public SnakesGame() {
		...
		pellets = new Pellets(Color.GREEN.darker(), numPellets);

		// create the board and necessary event listeners
		setSize((BOARD_WIDTH + 1) * SEGMENT_SIZE, (BOARD_HEIGHT + 1) * SEGMENT_SIZE + 60);
